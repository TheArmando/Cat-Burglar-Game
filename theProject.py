...
BED1M = [1.3, CENTER, '1_Bed1_Full.gif', BLANK, "SAY:     Hey, this isn't the time||                for a cat nap!"]
BED1P = [1.4, CENTER, '1_Bed1_Full.gif', BLANK, "SAY:(Pawses to reflect on the||              beautifur nature scene)"]
BED1H = [1.5, CENTER, '1_Bed1_Full.gif', BLANK, "SAY:      Resist the urge to claw the fabric..||             RESIST THE URGE TO CLAW IT!"]
...
BATH1GF = [2.31, CENTER, '2_Bath1_Full.gif', BLANK, "SAY:   Mmm this would be great chance||                for a frisky glass of milk!"]
BATH1GE = [2.32, CENTER, '3_Bath1_Empty.gif', BLANK, "SAY:  Mmm this would be great chance||                for a frisky glass of milk!        "]
BATH1CF = [2.41, CENTER, '2_Bath1_Full.gif', BLANK, "SAY:           OoOoOo I'd love to knock these over..||           Not yet... not yet...."]
BATH1CE = [2.42, CENTER, '3_Bath1_Empty.gif', BLANK, "SAY:          OoOoOo I'd love to knock these over..||           Not yet... not yet...."]

HALL1 = [3, CENTER, '4_Hall1_Full.gif']
HALL1_L = [3.1, CENTER, '4_Hall1_Full.gif', BLANK, "SAY:     Purrhaps I should explore the||               rest of the mansion furst..."]
# Hall1 PaintingL and PaintingR
HALL1PL = [3.2, CENTER, '4_Hall1_Full.gif', BLANK, "SAY:      I would cat nab this..||                  but im furrr too lazy!"]
HALL1PR = [3.3, CENTER, '4_Hall1_Full.gif', BLANK, "SAY:      That painting is even further away! ||    Too much effort..."]
...
STUDY1C = [4.2, CENTER, '5_Study1_Half.gif', BLANK, "SAY:    Nyawwwwn, cozy couch time?..||             I'l lounge later!"]
STUDY1CO = [4.21, CENTER, '6_Study1_Full.gif', BLANK, "SAY:  Nyawwwwn, cozy couch time?..||             I'l lounge later!"]
STUDY1BL = [4.3, CENTER, '5_Study1_Half.gif', BLANK, "SAY:   Hmmm.. these books would make ||         great tearing paper!!"]
STUDY1BLO = [4.31, CENTER, '6_Study1_Full.gif', BLANK, "SAY: Hmmm.. these books would make ||         great tearing paper!!"]
STUDY1BR = [4.4, CENTER, '5_Study1_Half.gif', BLANK, "SAY:   The more things to prance around ||          and shred, the better!!"]
STUDY1BRO = [4.41, CENTER, '6_Study1_Full.gif', BLANK, "SAY: The more things to prance around ||          and shred, the better!!"]
# STUDY top 4 items with Opened and closed versions
STUDY1_POT1 = [4.5, CENTER, '5_Study1_Half.gif', BLANK, "SAY:   I want to push it off...||                   A little tap couldn't hurt right?"]
STUDY1_POT1O = [4.51, CENTER, '6_Study1_Full.gif', BLANK, "SAY: I want to push it off...||                   A little tap couldn't hurt right?"]
STUDY1_POT2 = [4.6, CENTER, '5_Study1_Half.gif', BLANK, "SAY:       Kitty instincts kicking in!!..||                Argh I've gotta knock it off!!"]
STUDY1_POT2O = [4.7, CENTER, '6_Study1_Full.gif', BLANK, "SAY:      Kitty instincts kicking in!!..||                Argh I've gotta knock it off!!"]
STUDY1_POT3 = [4.8, CENTER, '5_Study1_Half.gif', BLANK, "SAY:       What a wondifur creation!..||                         Now to make it could soar through the air!"]
STUDY1_POT3O = [4.81, CENTER, '6_Study1_Full.gif', BLANK, "SAY:     What a wondifur creation!..||                         Now to make it could soar through the air!"]
STUDY1_POT4 = [4.9, CENTER, '5_Study1_Half.gif', BLANK, "SAY:       What is this thing? ||                            nobody would notice if I pushed it right?"]
STUDY1_POT4O = [4.91, CENTER, '6_Study1_Full.gif', BLANK, "SAY:     What is this thing? ||                            nobody would notice if I pushed it right?"]

STUDY2 = [5, CENTER, '7_Study2_Full.gif']
STUDY2E = [5.1, CENTER, '8_Study2_Empty.gif']
STUDY2C = [5.2, CENTER, 'Letter_Hint2.gif']
# Study2 flowers with picture, both chandliers, both horses, pen and the base that holds the base, Lamp
STUDY2FF = [5.3, CENTER, '7_Study2_Full.gif', BLANK, "SAY:      Roses are red, Violets are blue..   ||                         Uh oh I think I'm allergic to them ACHOO!"]
STUDY2FE = [5.31, CENTER, '8_Study2_Empty.gif', BLANK, "SAY:    Roses are red, Violets are blue..   ||                         Uh oh I think I'm allergic to them ACHOO!"]
STUDY2CLF = [5.4, CENTER, '7_Study2_Full.gif', BLANK, "SAY:             I can totally jump up and swing from these||                     On second thought I have work to do.."]
STUDY2CLE = [5.41, CENTER, '8_Study2_Empty.gif', BLANK, "SAY:           I can totally jump up and swing from these||                     On second thought I have work to do.."]
STUDY2CRF = [5.5, CENTER, '7_Study2_Full.gif', BLANK, "SAY:             I can totally jump up and swing from these||                     On second thought I have work to do.."]
STUDY2CRE = [5.51, CENTER, '8_Study2_Empty.gif', BLANK, "SAY:           I can totally jump up and swing from these||                     On second thought I have work to do.."]
STUDY2HLF = [5.6, CENTER, '7_Study2_Full.gif', BLANK, "SAY:        Ha ha these two horses must be good||                neighhhh-bors!"]
STUDY2HLE = [5.61, CENTER, '8_Study2_Empty.gif', BLANK, "SAY:      Ha ha these two horses must be good||                neighhhh-bors!"]
STUDY2HRF = [5.7, CENTER, '7_Study2_Full.gif', BLANK, "SAY:        Ha ha these two horses must be good||                neighhhh-bors!"]
STUDY2HRE = [5.71, CENTER, '8_Study2_Empty.gif', BLANK, "SAY:      Ha ha these two horses must be good||                neighhhh-bors!"]
STUDY2PF = [5.8, CENTER, '7_Study2_Full.gif', BLANK, "SAY:      Tickle my whiskers! That feather||               looks to be a load of fun! "]
STUDY2PE = [5.81, CENTER, '8_Study2_Empty.gif', BLANK, "SAY:    Tickle my whiskers! That feather||               looks to be a load of fun! "]
STUDY2LF = [5.9, CENTER, '7_Study2_Full.gif', BLANK, "SAY:            Whose bright idea was it to put this here?||                         It's brilliant!(beacuse it's just a lamp)"]
STUDY2LE = [5.91, CENTER, '8_Study2_Empty.gif', BLANK, "SAY:          Whose bright idea was it to put this here?||                         It's brilliant!(beacuse it's just a lamp)"]

STAIRS = [6, CENTER, '9_Hall2_Full.gif']
# Stairs, entire desk and mirror
STAIRSM = [6.1, CENTER, '9_Hall2_Full.gif', BLANK, "SAY:   Mirrors are mewly a reflection||            of what's outside oneself"]

SAFEROOM = [7, CENTER, '14_Safe_Full.gif']
# Saferoom, face in the mirror, the glass
SAFEROOMF = [7.1, CENTER, '14_Safe_Full.gif', BLANK, "SAY:             This man... It's as though||                          he's staring into the depths of my soul..."]
SAFEROOMG = [7.2, CENTER, '14_Safe_Full.gif', BLANK, "SAY:             What a warm fireplace, if only it||                          was turned on I'd stretch out and relax!"]
# Saferoom painting with no key, and with key
SAFEROOMPN = [7.3, CENTER, '14_Safe_Full.gif', BLANK, "SAY:             Such a majestic and glorious fluffy angel...||                           a leaping bundle of heavenly inpsiration!!! "]
SAFEROOMPY = [7.31, CENTER, '14_Safe_Full.gif', BLANK, "SAY:            Wait a minute, there's a keyhole behind||                          this  painting! (click again to open safe)"]

LIVING = [8, CENTER, '10_Living_Full_Note.gif']
LIVINGC = [8.1, CENTER, 'Letter_Hint3.gif']
LIVINGE = [8.2, CENTER, '10_Living_Full.gif']
LIVINGUV = [8.3, CENTER, '10_Living_Full_UV_Note.gif']
...
LIVINGMF = [8.4, CENTER, '10_Living_Full_Note.gif', BLANK, "SAY:       Yuck!! This mirror is furr too dirty||                      to marvel at my glorious coat of furr!"]
LIVINGME = [8.41, CENTER, '10_Living_Full.gif', BLANK, "SAY:           Yuck!! This mirror is furr too dirty||                      to marvel at my glorious coat of furr!"]
LIVINGLLF1 = [8.5, CENTER, '10_Living_Full_Note.gif', BLANK, "SAY:      Hmmm... this light bulb is loose! ||                          Purrhaps I can replace it with another.. "]
LIVINGLLE1 = [8.51, CENTER, '10_Living_Full.gif', BLANK, "SAY:          Hmmm... this light bulb is loose! ||                          Purrhaps I can replace it with another.. "]
LIVINGLLF2 = [8.52, CENTER, '10_Living_Full_Note.gif', BLANK, "SAY:             Hey!! The UV light from earlier fits here! ||                      (Click again to replace lightbulb) "]
LIVINGLLE2 = [8.53, CENTER, '10_Living_Full.gif', BLANK, "SAY:                  Hey!! The UV light from earlier fits here! ||                      (Click again to replace lightbulb) "]
LIVINGLLF3 = [8.52, CENTER, '10_Living_Full_Note.gif', BLANK, "SAY:     aaaannnnd voila!!! || "]
LIVINGLLE3 = [8.53, CENTER, '10_Living_Full.gif', BLANK, "SAY:          aaaannnnd voila!!! || "]
LIVINGLRF = [8.6, CENTER, '10_Living_Full_Note.gif', BLANK, "SAY:       Hey wait a minute!!!.. ||                        Nope nevermind it's just another lamp"]
LIVINGLRE = [8.7, CENTER, '10_Living_Full.gif', BLANK, "SAY:            Hey wait a minute!!!.. ||                        Nope nevermind it's just another lamp"]
LIVINGCF = [8.6, CENTER, '10_Living_Full_Note.gif', BLANK, "SAY:       I could lay down.. but ||                      I'm not really feline it.."]
LIVINGCE = [8.7, CENTER, '10_Living_Full.gif', BLANK, "SAY:            I could lay down.. but ||                      I'm not really feline it.."]

BED2 = [9, CENTER, '11_Bed2_Full.gif']
BED2D = [9.4, CENTER, 'Hint5+Bulb.gif']
BED2L = [9.41, CENTER, 'Letter_Hint5.gif']
# Bed, PillowNShoes, Couch (top part)
BED2B = [9.1, CENTER, '11_Bed2_Full.gif', BLANK, "SAY:           (jumps on top of for 10 minutes)||                         Okay that's enough for today."]
BED2P = [9.2, CENTER, '11_Bed2_Full.gif', BLANK, "SAY:          WHO KNOCKED THIS PILLOW ON THE FLOOR?||                     WAS ANOTHER CAT THIEF HERE??"]
BED2CT = [9.3, CENTER, '11_Bed2_Full.gif', BLANK, "SAY:       The quick sly cat thief ||                        lounged lazily on the couch.. nah!"]
# Bed, with textbox on the light bulb
BED2DT = [9.41, CENTER, 'Hint5+Bulb.gif', BLANK, "SAY:          ||                    (Aqcuired UV Lightbulb x1)"]

BATH2 = [10, CENTER, '12_Bath2_Full.gif']

CELLAR = [11, CENTER, '15_Cellar_Full.gif']
CELLARN = [11.1, CENTER, 'Letter_Hint4.gif']  # cellar note
CELLARE = [11.2, CENTER, '15_Cellar_Empty.gif']  # cellar empty

CELLAR_BOXF = [12, CENTER, 'Cellar_CU.gif']
CELLAR_BOXE = [12.2, CENTER, 'Cellar_CU_Empty.gif']  # cellar close up
DIAMOND_KEY = [12.1, CENTER, '[dkey_TEXT].gif']
...
DIAMOND_VID = [98]
for k in range(0, 30):
    DIAMOND_VID.append(CENTER)
    DIAMOND_VID.append("dkey" + str(k) + ".gif")
k = None
# Safe Animation
SAFE_ANIMATE = [99]
for k in range(1, 61):
...
END = [100, CENTER, 'diamond_get.gif']  # Uses the text box.
...
# 6 - Has inserted the lightbulb
# 7 - Note 4 in the cellar
# 8 - Diamond Key
inventory = ['no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no']  # etc. add on if needed
...
def main():
    ...
    while True:
            ...
            # Hall1 with the note in hand
                ...
                draw_image()
                hot_spots(BED1, Point(0, 105), Point(83, 44), None, STUDY1, Point(408, 279), Point(540, 0), None, STAIRS, Point(168, 283), Point(245, 81), None, HALL1PL, Point(73, 320), Point(147, 154), None, HALL1PR, Point(364, 224), Point(382, 160))

            # First encounter with the Hall
            elif position[0] == HALL1 and position[1][1] == 'no':
                draw_image()
                hot_spots(BED1, Point(0, 105), Point(93, 44), None, STUDY1, Point(408, 279), Point(540, 0), None, HALL1_L, Point(168, 283), Point(245, 81), None, HALL1PL, Point(73, 320), Point(147, 154), None, HALL1PR, Point(364, 224), Point(382, 160))
            ...
            # Study 1
                ...
                draw_image()
                hot_spots(HALL1, Point(232, 52), Point(307, 7), None, STUDY1O, Point(258, 290), Point(277, 251), None, STUDY1C, Point(74, 207), Point(431, 104), None, STUDY1BL, Point(149, 332), Point(250, 213), None, STUDY1BR, Point(363, 326), Point(458, 208), None, STUDY1_POT1, Point(61, 396), Point(99, 380), None, STUDY1_POT2, Point(171, 403), Point(217, 378), None, STUDY1_POT3, Point(281, 413), Point(324, 379), None, STUDY1_POT4, Point(386, 404), Point(438, 378))

            # Study open , after clicked on the books
            elif position[0] == STUDY1O:
                draw_image()
                hot_spots(HALL1, Point(232, 52), Point(307, 7), None, STUDY2, Point(0, 420), Point(67, 118), None, STUDY1CO, Point(74, 207), Point(431, 104), None, STUDY1BLO, Point(149, 332), Point(250, 213), None, STUDY1BRO, Point(363, 326), Point(458, 208), None, STUDY1_POT1O, Point(61, 396), Point(99, 380), None, STUDY1_POT2O, Point(171, 403), Point(217, 378), None, STUDY1_POT3O, Point(281, 413), Point(324, 379), None, STUDY1_POT4O, Point(386, 404), Point(438, 378))

            # Text boxes for the study1 and pot[s]
            elif position[0] == STUDY1C or position[0] == STUDY1BR or position[0] == STUDY1BL or position[0] == STUDY1_POT1 or position[0] == STUDY1_POT2 or position[0] == STUDY1_POT3 or position[0] == STUDY1_POT4:
                draw_image()
                hot_spots(STUDY1)

            # Text boxes for the study1 with open bookcase and pot[s]
            elif position[0] == STUDY1CO or position[0] == STUDY1BRO or position[0] == STUDY1BLO or position[0] == STUDY1_POT1O or position[0] == STUDY1_POT2O or position[0] == STUDY1_POT3O or position[0] == STUDY1_POT4O:
                draw_image()
                hot_spots(STUDY1O)
            ...
            elif position[0] == SAFEROOM and position[1][8] == "yes":
                draw_image()
                hot_spots(SAFEROOMPY, Point(182, 420), Point(350, 300), None, STAIRS, Point(463, 36), Point(530, 4), None, SAFEROOMF, Point(243, 255), Point(283, 221), None, SAFEROOMG, Point(185, 160), Point(343, 31))

            elif position[0] == SAFEROOM and position[1][8] == "no":
                draw_image()
                hot_spots(SAFEROOMPN, Point(182, 420), Point(350, 300), None, STAIRS, Point(463, 36), Point(530, 4), None, SAFEROOMF, Point(243, 255), Point(283, 221), None, SAFEROOMG, Point(185, 160), Point(343, 31))

            # Saferoom text boxes
            elif position[0] == SAFEROOMF or position[0] == SAFEROOMG or position[0] == SAFEROOMPN:
                draw_image()
                hot_spots(SAFEROOM)

            # The point of no return
            elif position[0] == SAFEROOMPY:
                draw_image()
                hot_spots(SAFE_COMBO)
            ...
            # if at living, does not have note, but does have the lightbulb, and has not cliked on the lamp yet
            elif position[0] == LIVING and position[1][3] == "no" and position[1][4] == "yes" and position[1][5] == "no":
                draw_image()
            ...
            # if at living and does not have the note, but does have the lightbulb, and has clicked on the lamp a first time already
            elif position[0] == LIVING and position[1][3] == "no" and position[1][4] == "yes" and position[1][5] == "yes" and position[1][6] == "no":
                draw_image()
                hot_spots(STAIRS, Point(253, 31), Point(301, 4), None, BED2, Point(426, 219), Point(456, 144), None, LIVINGC, Point(297, 97), Point(331, 73), 3, LIVINGMF, Point(241, 266), Point(314, 172), None, LIVINGCF, Point(206, 139), Point(343, 107), None, LIVINGLLF3, Point(0, 190), Point(80, 131), 6, LIVINGLRF, Point(475, 189), Point(540, 133), None, LIVINGCF, Point(0, 187), Point(136, 135))
            ...
            elif position[0] == LIVING and position[1][3] == "yes" and position[1][4] == "yes" and position[1][5] == "yes" and position[1][6] == "no":
                position[0] = LIVINGE
                draw_image()
                hot_spots(STAIRS, Point(253, 31), Point(301, 4), None, BED2, Point(426, 219), Point(456, 144), None, LIVINGME, Point(241, 266), Point(314, 172), None, LIVINGCE, Point(206, 139), Point(343, 107), None, LIVINGLLE3, Point(0, 190), Point(80, 131), 6, LIVINGLRE, Point(475, 189), Point(540, 133), None, LIVINGCE, Point(0, 187), Point(136, 135))

            # if at UV with no note
            elif position[0] == LIVING and position[1][3] == "no" and position[1][4] == "yes" and position[1][5] == "yes" and position[1][6] == "yes":
                position[0] = LIVINGUV
                draw_image()
                hot_spots(STAIRS, Point(253, 31), Point(301, 4), None, BED2, Point(426, 219), Point(456, 144), None, LIVINGC, Point(297, 97), Point(331, 73), 3)

            # if at UV with note
            elif position[0] == LIVING and position[1][3] == "yes" and position[1][4] == "yes" and position[1][5] == "yes" and position[1][6] == "yes":
            ...
            # Bedroom2 text boxes
                ...
                draw_image()
                hot_spots(BED2DT, Point(0, 420), Point(540, 0))
                clear_image()
                draw_image()
                hot_spots(BED2L)
                clear_image()
            ...
            # Bathroom2 todo: stuff, stuff needs to be done.
                ...
                draw_image()
                hot_spots(BED2, Point(15, 206), Point(81, 151), None, CELLAR, Point(337, 218), Point(350, 116))

            # Cellar
            elif position[0] == CELLAR and position[1][7] == "no" and position[1][8] == "no":
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39), None, CELLARN, Point(225, 130), Point(257, 104), 7, CELLAR_BOXF, Point(355, 269), Point(410, 198))

            elif position[0] == CELLAR and position[1][7] == "no" and position[1][8] == "yes":
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39), None, CELLARN, Point(225, 130), Point(257, 104), 7, CELLAR_BOXE, Point(355, 269), Point(410, 198))

            elif position[0] == CELLARN:
                draw_image()
                hot_spots(CELLAR, Point(0, 420), Point(540, 0))

            elif position[0] == CELLAR and position[1][7] == "yes" and position[1][8] == "no":
                position[0] = CELLARE
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39), None, CELLAR_BOXF, Point(355, 269), Point(410, 198))

            elif position[0] == CELLAR and position[1][7] == "yes" and position[1][8] == "yes":
                position[0] = CELLARE
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39), None, CELLAR_BOXE, Point(355, 269), Point(410, 198))

            elif position[0] == CELLAR_BOXF:
                draw_image()
                hot_spots(DIAMOND_VID, Point(170, 273), Point(370, 218), 8)

            elif position[0] == CELLAR_BOXE:
                draw_image()
                hot_spots(CELLAR, Point(0, 420), Point(540, 0))

            elif position[0] == DIAMOND_VID:
                draw_image(0.05)
                hot_spots(DIAMOND_KEY)

            elif position[0] == DIAMOND_KEY:
                draw_image()
                hot_spots(CELLAR_BOXE, Point(0, 420), Point(540, 0))
