...
def main():
    ...
    while True:
            ...
            if position[0] == START:
                draw_image()
                hot_spots(BED1, Point(0, 420), Point(540, 0))
            ...
            # First encounter with the Hall
                ...
                draw_image()
                hot_spots(BED1, Point(0, 105), Point(93, 44), None, STUDY1, Point(408, 279), Point(540, 0), None, HALL1_L, Point(168, 253), Point(216, 114))

            elif position[0] == HALL1_L:
                draw_image()
                hot_spots(HALL1)
            ...
            # Study 1
                ...
                draw_image()
                hot_spots(HALL1, Point(232, 52), Point(307, 7), None, STUDY1O, Point(258, 290), Point(277, 251))
            ...
            # Display normal, there's a check on inventory because of the next if statement
                ...
                draw_image()
                hot_spots(STUDY1O, Point(247, 62), Point(290, 9), None, STUDY2C, Point(327, 87), Point(386, 45), 1)
            ...
            # Stairs shot,
                ...
                draw_image()
                hot_spots(SAFEROOM, Point(229, 203), Point(330, 102), None, HALL1, Point(0, 50), Point(50, 0), None, LIVING, Point(171, 237), Point(187, 100), None, HALL1, Point(0, 172), Point(118, 0), None, HALL1, Point(0, 420), Point(55, 177), None, HALL1, Point(55, 420), Point(55, 177), None, HALL1, Point(55, 420), Point(118, 280))

            # Saferoom, todo: fix so that the user cannot directly open the safe (duh)
            elif position[0] == SAFEROOM:
                draw_image()
                hot_spots(SAFE_COMBO, Point(182, 420), Point(350, 300), None, STAIRS, Point(463, 36), Point(530, 4))

            # living room, todo: split this to incorporate the UV situation.
            elif position[0] == LIVING and position[1][3] == "no":
                draw_image()
            ...
            # Bedroom2, todo: add the drawer hotspot to give the lightbulb
