...
LIVINGUV = [8.3, CENTER, 'Living1_UVNote.gif']
...
CELLAR_BOX = [12, CENTER, 'Cellar_CU.gif']  # cellar close up
...
def main():
    ...
    while True:
            ...
            # Bedroom2 text boxes
                ...
                draw_image()
                hot_spots(BED2L, Point(0, 420), Point(540, 0))
                clear_image()
                draw_image()
            ...
            # Cellar
                ...
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39), None, CELLARN, Point(225, 130), Point(257, 104), 7, CELLAR_BOX, Point(355, 269), Point(410, 198))

            elif position[0] == CELLAR and position[1][7] == "no" and position[1][8] == "yes":
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39), None, CELLARN, Point(225, 130), Point(257, 104), 7)
                ...
                position[0] = CELLARE
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39), None, CELLAR_BOX, Point(355, 269), Point(410, 198))

            elif position[0] == CELLAR and position[1][7] == "yes" and position[1][8] == "yes":
                position[0] = CELLARE
                draw_image()
                hot_spots(BATH2, Point(20, 85), Point(99, 39))

            elif position[0] == CELLAR_BOX:
                draw_image()
