...
# this is an example, you can use this or change it
SAFE_BASE = [15, CENTER, 'vault_ext.gif']
SAFE_R1 = [15.1, CENTER, 'vault_ext.gif', BLANK, "1RED"]
